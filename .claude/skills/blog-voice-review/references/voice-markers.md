# Voice Markers & Core Patterns

_Extracted from style-guide.md - Core voice characteristics and structural patterns_

## Voice Reference Posts

Study these for authentic Fabio voice (local files):
- `content/en/blog/2017/12/08/adventures-in-serverless-land-to-support-a-fight-against-corruption/index.md` - Chronological debugging narrative ("1st try" → failed, "2nd try" → failed, etc.)
- `content/en/blog/2014/09/11/running-gui-apps-with-docker/index.md` - 400 words, jumps right in, no fluff
- `content/en/blog/2014/08/26/devstep-development-environments-powered-by-docker-and-buildpacks/index.md` - Personal motivation upfront, honest about being third attempt
- `content/en/blog/2013/05/24/stop-wasting-bandwidth-with-vagrant-cachier/index.md` - Shows numbers, includes testimonials naturally
