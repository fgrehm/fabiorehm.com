...
**GitHub Copilot** got a lot of hype when it was released, but my initial skepticism proved justified for my specific use case. The VS Code vim plugin integration wasn't great, and the constant autocomplete suggestions felt annoying and interrupting - I didn't like what it was suggesting most of the time. To be fair, I didn't spend much time with it, so this might not be representative of its full capabilities. I recently started getting that same interrupting feeling with Cursor's AI features too.
